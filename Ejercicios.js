...
let ejercicio= +prompt("Ingrese el número de Ejercicio");


const calcularMayor = (v1,v2,v3) => {
    let mayor= v1 > v2? v1 : v2;
    mayor=mayor >v3?mayor : v3;
    return mayor;
};

const primerosMultiplos = ()=>{
        let arrMultiplos = [];
        let index=0;
        let numero=0;
        while (index<50){
                if(numero%7==0 && numero%2!=0 && numero%3!=0 && numero%5!=0 ){
                        arrMultiplos.push(numero); 
                        index++;
                }
                numero++;
...
const FiltrarPeliculas = () => {
        ...
        for (let index = 0; index < peliculas.length; index++) {               
                const element = peliculas[index].original_language;
                if (element=="en"){
                        arrPeliculas.push(peliculas[index].original_title); 
                }
        }
        return arrPeliculas;
}
const DezplazarArreglo = (longitud) =>{
    let arreglo=[]
    let subarreglo=[];
 
    for (let index = 0; index < longitud; index++) {
        let valor= +prompt("Ingrese valor número "+(index+1) + ": ");
        arreglo.push(valor);
    }
    let desplazamiento= +prompt("Ingrese el valor del arreglo para dezplazamiento");
    if (desplazamiento in arreglo){

        for (let index = 0; index < arreglo.length; index++) {
            if (arreglo[index] === desplazamiento) {

                for (let j = 0; j < desplazamiento; j++) {
                    
                    const valor = arreglo[j];
                    subarreglo.push(valor);
        ...
        arreglo=arreglo.concat(subarreglo);

    }else{
        console.log("Valor no encontrado en arreglo, no se desplazará");
    }
    return arreglo;
}
...
if(ejercicio==1){
        let valor1= +prompt("Ingrese su primer valor");
        let valor2= +prompt("Ingrese su segundo valor");
        let valor3= +prompt("Ingrese su tercer valor");
        alert("El numero mayor es: "+ calcularMayor(valor1,valor2,valor3));
        console.log("El numero mayor es: "+ calcularMayor(valor1,valor2,valor3));
        
}else if (ejercicio==2){
        console.log(primerosMultiplos());
        alert("Se imprimió en consola");
}else if (ejercicio==3){
        let ventas= +prompt("Ingrese las ventas (S/)");
        if(ventas>=0){
                alert("La comisión es: "+ calcularComision(ventas));
        }else{
        ...
        const arreglo = +prompt("Ingrese longitud del arreglo");
        if (arreglo>0){
            const long=DezplazarArreglo(arreglo);
            if (long.length > 0){
                console.log(long);
                alert("Se imprimió en consola la respuesta");
            }else{
